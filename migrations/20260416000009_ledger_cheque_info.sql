-- Migration: Add cheque number to account ledger
-- Description: Updates the get_account_ledger RPC to include the cheque_number field, allowing bank statements to show cheque details.
